                                ...
                                <div class="card overflow-hidden">
                                    <div class="card-body position-relative">
                                        <div class="text-center mt-3">
                                            ...
                                            <p class="text-muted text-sm">email : <a href="mailto:" class="link-primary">
                                            </p>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-6">
                                                                ...
                                                                <p class="mb-0">Perform task related to project manager
                                                                    with the 100+ team under my observation. Team management
                                                                    is key
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" name="nama" placeholder="Nama usaha" required />
                                        </div>
                                        <div class="mb-3">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="wa" placeholder="WhatsApp" class="form-control">
                                        </div>
                                        <div class="mb-3">
                                            <label for="Instagram" class="form-label">Instagram</label>
                                            <input type="text" name="ig" placeholder="Instagram" class="form-control">
                                        </div>
                                        <div class="mb-3">
                                            <label for="Facebook" class="form-label">Facebook</label>
                                            <input type="text" name="fb" placeholder="Facebook" class="form-control">
                                        </div>
                                        <div class="mb-3">
                                            <label for="TripsAdvisor" class="form-label">TripsAdvisor</label>
                                            <input type="text" name="ta" placeholder="TripsAdvisor" class="form-control">
                                        </div>
                                    </div>
                                    <div class="col-md-12">
...
@push('js')
    ...
    <script>
        (function () {
            new SimpleMDE({ element: document.querySelector('#tentang') });
        })();
    </script>
    <script>
