...
<head>
    ...
    <style>
        ...
        .payment-c {
            flex: 1 1 45%; /* Set column width to 45% */
                            ...
                            <div class="row g-3">
                                <div class="col-12">
                                    <div class="row align-items-center g-3">
                                        <div class="col-sm-6">
                                            <img src="{{ asset('assets/images/rinjani.png') }}" alt=""
                                                srcset="" width="100px">
                                ...
                                <div class="col-sm-6">
                                    <div class="border rounded p-3" style="background-color: rgb(141, 191, 248)">
                                        <h6 class="mb-0">Traveler:</h6>
                                        <h5 class="">Little Monster Travel sgp</h5>
                                        <p class="mb-0">Singapore</p>
                                        <p class="mb-0">littlemonsterstravel@gmail.com</p>
                                        <p class="mb-0">(+65) 88842635</p>
                                    </div>
                                </div>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td>1</td>
                                                    <td>Trekking Rinjani 3 Days / 2 Nights Sembalun to Torean</td>
                                                    <td class="text-end">{{$qty}}</td>
                                                    <td class="text-end">IDR {{$price}}.00</td>
                                                    <td class="text-end">IDR {{$total}}.00</td>
                                                </tr>
                                            </tbody>
                                        </table>
                                    </div>
                                ...
                                <div class="col-12">
                                    <div class="invoice-total ms-auto">
                                        <div class="row">
                                            ...
                                            <div class="col-5">
                                                <p class="mb-1 text-end">IDR {{$total}}.00</p>
                                            </div>
                                            <div class="col-7">
                                                <p class="text-muted mb-1 text-start">Discount :</p>
                                            </div>
                                            <div class="col-5">
                                                <p class="mb-1 text-end text-success">IDR {{$discount}}.00</p>
                                            </div>
                                            <div class="col-7">
                                                <p class="f-w-500 mb-1 text-start">Grand Total :</p>
                                            </div>
                                            <div class="col-5">
                                            ...
                                            <div class="col-7">
                                                <p class="f-w-800 mb-1 text-start">Amount Due :</p>
                                            </div>
                                            <div class="col-5">
                                                <p class="f-w-800 mb-1 text-end ">IDR {{$amount_due}}.00</p>
                                            </div>
                                            <div class="col-12">
                                                <hr>
                                                <p class="f-w-800 text-center">Addiitonal Item</p>
                                                <hr>
                                            </div>
                                            <div class="col-7">
                                                <p class="f-w-500 mb-1 text-start">4 extra porter :</p>
                                            </div>
                                            <div class="col-5">
                                                <p class="f-w-500 mb-1 text-end ">IDR 5.000.000.00</p>
                                            </div>
                                            <div class="col-7">
                                                <p class="f-w-500 mb-1 text-start">1 Private guide :</p>
                                            </div>
                                            <div class="col-5">
                                                <p class="f-w-500 mb-1 text-end ">IDR 1.500.000.00</p>
                                            </div>
                                            <div class="col-7">
                                                <p class="f-w-500 mb-1 text-start">2 extra rooms :</p>
                                            </div>
                                            <div class="col-5">
                                                <p class="f-w-500 mb-1 text-end ">IDR 800.000.00</p>
                                            </div>
                                            <div class="col-7">
                                                <p class="f-w-500 mb-1 text-start">Extra transportation to Kuta after the trek :</p>
                                            </div>
                                            <div class="col-5">
                                                <p class="f-w-500 mb-1 text-end ">IDR 700.000.00</p>
                                            </div>
                                            <div class="col-7">
                                                <p class="f-w-500 mb-1 text-start">Extra food+porter :</p>
                                            </div>
                                            <div class="col-5">
                                                <p class="f-w-500 mb-1 text-end ">IDR 1.500.000.00</p>
                                            </div>
                                ...
                                <div class="col-12">
                                    ...
                                    <div style="padding-left: 30px">
                                        <div class="payment-r">
                                            <div class="payment-c">
                                                <p class="mb-1 f-w-500">1. Bank Transfer - BNI</p>
                                                <p>
                                                    Bank Name: <strong>Bank Negara Indonesia (BNI)</strong><br>
                                                    Account Name: <strong>Jamal</strong><br>
                                                    Account Number: <strong>1784786912</strong><br>
                                                    SWIFT Code: <strong>BNINIDJA</strong><br>
                                                    Please mention the invoice number as the reference.
                                                </p>
                                            </div>
                                            <div class="payment-c">
                                                <p class="mb-1 f-w-500">2. PayPal</p>
                                                <p>
                                                    Send payment to: <strong>bookmountrinjani@gmail.com</strong><br>
                                                    Please include the invoice number in the payment notes.
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                    <p class="mb-0 f-w-600"> - Please make the remaining payment of <strong>IDR {{$deposite}}.00</strong>.</p>

                                    <p class="mb-0 f-w-600"> - It was a pleasure working with you and your team. We hope you
                                        will keep us in mind for future trips.
                                        Thank You!</p>
                                </div>
